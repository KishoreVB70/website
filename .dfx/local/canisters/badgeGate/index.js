...
import { idlFactory } from './badgeGate.did.js';
export { idlFactory } from './badgeGate.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BADGEGATE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./badgeGate.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the badgeGate canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./badgeGate.did.js")._SERVICE>}
 */
export const badgeGate = createActor(canisterId);
